...
@section('content')
    <div class="space-y-6">
        <!-- Page Header -->
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create Menu</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Add a new menu item to the navigation</p>
        </div>
                            ...
                            <select name="section_title" id="section_title"
                                ...
                                @foreach ($existingSections as $section)
                                    <option value="{{ $section }}"
                                        {{ old('section_title') == $section ? 'selected' : '' }}>
                                        {{ $section }}
                                    </option>
                                @endforeach
