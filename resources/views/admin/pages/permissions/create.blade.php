...
@section('content')
    <div class="space-y-6">
        <!-- Page Header -->
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create Permission</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Add a new permission to the system</p>
        </div>
            ...
            <form action="{{ route('admin.permissions.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="block w-full rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white shadow-sm dark:shadow-md focus:border-blue-500 focus:ring-2 focus:ring-blue-500 px-4 py-4 transition-colors">{{ old('description') }}</textarea>
                </div>
